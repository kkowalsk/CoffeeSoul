...
def init():
    # In-memory only: load the seed data, build the domain objects, and run the
    # round robin. No database -- persistence lives in the containerized stack
    # (see ../../stack/microservice).
    brews = []
    comrades = []
    procurements = []
